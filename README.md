...
| File | Description |
|---|---|
| [PowerBI_Sales_Data.xlsx](PowerBI_Sales_Data.xlsx) | Source workbook |
| [FactSales.csv](FactSales.csv) | Sales fact table |
| [DimProducts.csv](DimProducts.csv) | Product dimension |
| [DimCustomers.csv](DimCustomers.csv) | Customer dimension |
| [DAX_Measures.txt](DAX_Measures.txt) | DAX measures |
